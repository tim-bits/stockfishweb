...
//tj
widget.squareDistanceExported = function(s1, s2) {
  return squareDistance(s1, s2);
};
  // widget.fenToObjExported = function(fen) {
  //   return fenToObj(fen);
  // };
  widget.objToFenExported = function(obj) {
    return objToFen(obj);
  };
//tj
...
// tj
// window.ChessBoard.squareDistance = widget.squareDistance;
//tj
